...
export default function MobileHero(){
    return(
        <ImageBackground source={header} resizeMode="cover" className="  flex justify-center items-center w-full h-[545px] ">
        ...
        <Text className=" text-center text-zinc-300 text-sm font-medium tracking-[-0.5px] leading-6">
